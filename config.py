...
class Config:
	...
	def use_dataset(self, dataset):
		...
		if dataset.startswith("lirads") or dataset == "clinical":
			self.base_dir = "/data/vision/polina/users/clintonw/code/voi-classifier/"
			self.coord_xls_path = '/data/vision/polina/users/clintonw/code/voi-classifier/excel/Prototype1e.xlsx'
			if dataset == "clinical":
				self.run_num = 4
				self.test_run_num = 4
